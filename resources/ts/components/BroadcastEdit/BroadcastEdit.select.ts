...
export const scanShowGroupsSelect = createSelector(
  [(state: RootState) => state.broadcastEdit.form.target],
...
export const groupOptions = createSelector(
  [(state: RootState) => state.broadcastEdit.groups],
  (groups: Group[]) => {
...
export const selectedGroupOptions = createSelector(
  [
    (state: RootState) => state.broadcastEdit.groups,
    (state: RootState) => state.broadcastEdit.form.groups,
  ],
...
export const templateOptions = createSelector(
  [(state: RootState) => state.broadcastEdit.templates],
  (templates: Template[]) => {
...
export const messagePreviewText = createSelector(
  [
    (state: RootState) => state.broadcastEdit.templates,
    (state: RootState) => state.broadcastEdit.form.template,
  ],
